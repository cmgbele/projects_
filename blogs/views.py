...
from .serializers import ResendOTPSerializer, LoginSerializer, VerifyOTPSerializer
...
@swagger_auto_schema(method='post', 
                    ...
                    ``{
                        ...
                        400: openapi.Response("""An example of failure is:
                        ``{
                        "message": "failed",
                        "error": {
                            "email": [
...
def Blog_view(request):
    ...
    if request.method == "GET":
        ...
        serializer = BlogSerializer(user, data=request.data, partial=True)
        if serializer.is_valid(): 
